...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class GoogleApiServicesLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>sheets</b> with <b>com.google.apis:google-api-services-sheets</b> coordinates and
         * with version reference <b>google.sheets</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getSheets() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("google.api.services.sheets");
        }
    ...
    public static class GoogleHttpClientLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>google.http.client</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class GoogleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>google.sheets</b> with value <b>v4-rev20241008-2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSheets() { return getVersion("google.sheets"); }
    ...
    public static class GoogleApiVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>google.api.client</b> with value <b>2.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class GoogleHttpVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>google.http.client</b> with value <b>1.45.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getClient() { return getVersion("google.http.client"); }
